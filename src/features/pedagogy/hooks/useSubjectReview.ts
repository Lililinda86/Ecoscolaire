...
interface State { rows: SubjectReviewRow[]; secondaryRows: SecondaryRow[]; decisions?: SubjectDecision[]; documentaryDecisions?: DocumentaryDecision[]; loading: boolean; error: string | null; refresh: () => Promise<void>; schoolId?: string; yearId?: string; owner: boolean }
