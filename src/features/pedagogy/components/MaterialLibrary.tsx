...
export function MaterialLibrary() {
  ...
  return <section className="pedagogy-card pedagogy-material-library" data-testid="material-library">
    ...
    <p>Consultation sans adoption : 8 curricula MINEDUB, 81 documents hébergés par MINESEC, 3 références GCE et 40 propositions originales préscolaires. Les PDF externes restent chez leur éditeur. Un filtre de classe indique une référence candidate, jamais une équivalence approuvée. Les ressources d’examen sans rattachement documenté restent visibles en choisissant « Toutes » les classes.</p>
