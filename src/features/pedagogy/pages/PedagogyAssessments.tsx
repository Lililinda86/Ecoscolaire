...
export default function PedagogyAssessments() {
  ...
  return <main className="pedagogy-page">
    ...
    {assessment && <section className="pedagogy-card no-print">
      ...
      <details><summary>Sources enseignées — périmètre de revue</summary><p>Comparer toutes les questions, réponses et explications à ce snapshot. Une absence d’alerte n’est pas une preuve de fidélité. Le curriculum et les ressources ne peuvent pas élargir les notions évaluées.</p>
