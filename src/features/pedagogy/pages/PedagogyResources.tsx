...
export default function PedagogyResources() {
  ...
  return <div className="pedagogy-page">
    <PedagogyHeader title="Ressources pédagogiques" description="Choisissez une classe, trouvez une ressource ou un modèle, puis consultez sa source avant de préparer la séance." /><PedagogyNav />
    <MaterialLibrary />
    <details className="pedagogy-card"><summary>Activités préscolaires par niveau</summary><EarlyYearsProgramPanel /></details>
    ...
    <section className="pedagogy-card"><h2>Modèles de préparation</h2>
      ...
      <p role="status" aria-label="Nombre de modèles originaux">{resources.length} modèle(s) affiché(s). Consultation locale, sans appel IA.</p>
    ...
    <details className="pedagogy-card"><summary>Exemples de parcours — simulation</summary><SyntheticReviewLab /></details>
    <details className="pedagogy-card"><summary>Provenance, couverture et revue pédagogique</summary>
      <button onClick={downloadRegistry}>Exporter le registre complet de provenance (JSON)</button>
    <section className="pedagogy-card"><h2>Dossier de revue pédagogique humaine</h2><p>Cinq exemples : maternelle FR, primaire FR/EN, secondaire FR/EN. Références MINEDUB localisées lorsqu’elles sont disponibles, exemples internes originaux, progression proposée, préparation, bilan/évaluation, corrigé, preuves d’objectifs et remédiation. Correspondances ITALO et décisions humaines en attente ; couverture secondaire partielle, détaillée dans la bibliothèque.</p><button onClick={downloadReviewPack}>Télécharger PEDAGOGICAL_REVIEW_PACK</button></section>
