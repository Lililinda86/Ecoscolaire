...
export const structuredReviewExcerpts: StructuredReviewExcerpt[] = [
  { id: 'primary-fr-sil-sharing', documentId: 'minedub-fr-primary-1', sourcePdfPage: 71, sourcePrintedPage: 72,
    sourceLocator: 'Unité 8 communications, nombres et calculs, colonne SIL', level: 'SIL', subject: 'Mathématiques', domain: 'Nombres et calculs', officialUnit: 'Unité 8 : communications', officialLesson: null,
    objectiveParaphrase: 'Relier un partage équitable en deux ou quatre parts à une représentation fractionnaire.', competencyParaphrase: 'Représenter une fraction à partir du partage d’un objet ou d’une collection.', recommendedHours: null, language: 'fr', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-fr-ce1-fractions', documentId: 'minedub-fr-primary-2', sourcePdfPage: 79, sourcePrintedPage: 80,
    sourceLocator: 'Unité 6 santé, nombres et calculs, colonne CE1', level: 'CE1', subject: 'Mathématiques', domain: 'Nombres et calculs', officialUnit: 'Unité 6 : santé', officialLesson: null,
    objectiveParaphrase: 'Reconnaître les éléments qui composent une fraction simple.', competencyParaphrase: 'Mobiliser les nombres et le calcul dans une situation quotidienne.', recommendedHours: null, language: 'fr', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-fr-ce2-fractions', documentId: 'minedub-fr-primary-2', sourcePdfPage: 79, sourcePrintedPage: 80,
    sourceLocator: 'Unité 6 santé, nombres et calculs, colonne CE2', level: 'CE2', subject: 'Mathématiques', domain: 'Nombres et calculs', officialUnit: 'Unité 6 : santé', officialLesson: null,
    objectiveParaphrase: 'Passer de la lecture d’une fraction simple à son écriture.', competencyParaphrase: 'Employer une notation fractionnaire dans un problème de la vie courante.', recommendedHours: null, language: 'fr', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-fr-cm1-fractions', documentId: 'minedub-fr-primary-3', sourcePdfPage: 74, sourcePrintedPage: 75,
    sourceLocator: 'Unité 4 métiers, nombres et calculs, colonne CM1', level: 'CM1', subject: 'Mathématiques', domain: 'Nombres et calculs', officialUnit: 'Unité 4 : métiers', officialLesson: null,
    objectiveParaphrase: 'Nommer et écrire une fraction puis la situer entre deux entiers consécutifs.', competencyParaphrase: 'Raisonner avec des fractions pour résoudre une situation numérique.', recommendedHours: null, language: 'fr', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-fr-cm2-fractions', documentId: 'minedub-fr-primary-3', sourcePdfPage: 74, sourcePrintedPage: 75,
    sourceLocator: 'Unité 4 métiers, nombres et calculs, colonne CM2', level: 'CM2', subject: 'Mathématiques', domain: 'Nombres et calculs', officialUnit: 'Unité 4 : métiers', officialLesson: null,
    objectiveParaphrase: 'Relier les écritures décimale et fractionnaire, et comparer une fraction à l’unité.', competencyParaphrase: 'Décomposer une fraction en un entier et une partie inférieure à un.', recommendedHours: null, language: 'fr', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-en-class2-sets', documentId: 'minedub-en-primary-1', sourcePdfPage: 48, sourcePrintedPage: 48,
    sourceLocator: 'Table 21 Mathematics, Sets and Logic, Class 2 column', level: 'Class 2', subject: 'Mathematics', domain: 'Sets and Logic', officialUnit: null, officialLesson: null,
    objectiveParaphrase: 'Sort objects using three or more attributes and depict their sets with Venn diagrams.', competencyParaphrase: 'Use set representations to organise objects by shared properties.', recommendedHours: null, language: 'en', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-en-class3-sets', documentId: 'minedub-en-primary-2', sourcePdfPage: 49, sourcePrintedPage: 50,
    sourceLocator: 'Table 21 Mathematics, Sets and Logic, Class 3 column', level: 'Class 3', subject: 'Mathematics', domain: 'Sets and Logic', officialUnit: null, officialLesson: null,
    objectiveParaphrase: 'Explain universal sets and subsets, and distinguish finite from infinite sets.', competencyParaphrase: 'Compare collections through their elements and set notation.', recommendedHours: null, language: 'en', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-en-class4-fractions', documentId: 'minedub-en-primary-2', sourcePdfPage: 49, sourcePrintedPage: 50,
    sourceLocator: 'Table 21 Mathematics, Numbers and Operations, Class 4 column', level: 'Class 4', subject: 'Mathematics', domain: 'Numbers and Operations', officialUnit: null, officialLesson: null,
    objectiveParaphrase: 'Add or subtract fractions with unlike denominators and multiply proper fractions.', competencyParaphrase: 'Apply fraction operations and equitable sharing in numerical problems.', recommendedHours: null, language: 'en', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-en-class5-proportion', documentId: 'minedub-en-primary-3', sourcePdfPage: 50, sourcePrintedPage: 51,
    sourceLocator: 'Table 21 Mathematics, Numbers and Operations, Class 5 column', level: 'Class 5', subject: 'Mathematics', domain: 'Numbers and Operations', officialUnit: null, officialLesson: null,
    objectiveParaphrase: 'Work out simple interest and solve direct or inverse proportion problems.', competencyParaphrase: 'Select arithmetic operations for practical proportional situations.', recommendedHours: null, language: 'en', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
  { id: 'primary-en-class6-fractions', documentId: 'minedub-en-primary-3', sourcePdfPage: 50, sourcePrintedPage: 51,
    sourceLocator: 'Table 21 Mathematics, Numbers and Operations, Class 6 column', level: 'Class 6', subject: 'Mathematics', domain: 'Numbers and Operations', officialUnit: null, officialLesson: null,
    objectiveParaphrase: 'Solve practical numerical problems involving common and decimal fractions.', competencyParaphrase: 'Use mathematical operations in everyday situations while considering fair distribution.', recommendedHours: null, language: 'en', status: 'PEDAGOGICAL_APPROVAL_REQUIRED' },
