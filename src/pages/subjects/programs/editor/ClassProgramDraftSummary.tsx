...
export const ClassProgramDraftSummary: React.FC<ClassProgramDraftSummaryProps> = ({ subjects }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
      <div className="p-3.5 rounded-xl border border-blue-100 dark:border-blue-900 bg-gradient-to-br from-blue-50/50 to-white dark:from-blue-950/20 dark:to-gray-900 shadow-sm flex flex-col justify-between">
      ...
      <div className="p-3.5 rounded-xl border border-indigo-150 dark:border-indigo-900 bg-gradient-to-br from-indigo-50/50 to-white dark:from-indigo-950/20 dark:to-gray-900 shadow-sm flex flex-col justify-between">
      ...
      <div className="p-3.5 rounded-xl border border-emerald-100 dark:border-emerald-950 bg-gradient-to-br from-emerald-50/50 to-white dark:from-emerald-950/20 dark:to-gray-900 shadow-sm flex flex-col justify-between">
