...
class CampayService {
    ...
    async requestToPay(token, amount, phoneNumber, description, externalReference) {
    ...
    async getTransactionStatus(token, reference) {
...
//# sourceMappingURL=campayService.js.map