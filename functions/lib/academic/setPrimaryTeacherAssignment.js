...
exports.setPrimaryTeacherAssignment = void 0;
const functions = require("firebase-functions");
const admin = require("firebase-admin");
exports.setPrimaryTeacherAssignment = functions.https.onCall(async (data, context) => {
        ...
        return await db.runTransaction(async (transaction) => {
            ...
            if (linkByStaffSnap.exists) {
                ...
                if (linkByStaffData.isActive === true) {
                    ...
                    if (linkByUser.staffId !== cleanTeacherStaffId ||
            ...
            let oldAssignmentData = null;
            let oldAssignmentRef = null;
            if (slotSnap.exists) {
                const slotData = slotSnap.data();
...
//# sourceMappingURL=setPrimaryTeacherAssignment.js.map