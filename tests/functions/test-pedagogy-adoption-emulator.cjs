...
(async () => {
  try {
    ...
    const sourceSnapshot = [{ id: 'synthetic-source', version: 1, subjectId: 'math', classSubjectId: 'math', curriculumUnitId: null, lessonTitle: 'Synthetic fractions', objective: null, pedagogicalContent: '1/2 = 2/4; 2/6 = 1/3; 3 + 4 = 7. Only these examples; no multiplication of two fractions.', teachingConfirmationId: 'synthetic-confirmation', teachingStatus: 'taught', effectiveTeachingDate: '2026-09-08' }];
